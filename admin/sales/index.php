                ...
                <tbody>
                    ...
                    $i = 1;
                        ...
                        while($row = $qry->fetch_assoc()):
                            $olist = $conn->query("SELECT ol.*,p.title,p.brand,concat(c.firstname,' ',c.lastname) as name,c.email,o.date_created FROM order_list ol inner join orders o on 
                            o.id = ol.order_id inner join `products` p on p.id = ol.product_id inner join clients c on c.id = o.client_id  where ol.order_id = '{$row['order_id']}' ");
                    ...
                    <tr>
                        ...
                        <td class="text-right"><?php echo number_format($roww['quantity'] * $roww['price'],2) ?></td>
                    </tr>
                    <?php endwhile; ?>
                    <?php endwhile; ?>

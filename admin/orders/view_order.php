...
$order = $conn->query("SELECT o.*, concat(c.firstname,' ',c.lastname) as client, o.eta_date FROM `orders` o inner join clients c on c.id = o.client_id where o.id = '{$_GET['id']}' ");
    ...
    <div class="card-body">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <p class="m-0"><small>Author: <?php echo $row['brand']?></small></p>
                        </td>
                        <td><?php echo isset($eta_date) ? date('Y-m-d H:i:s', strtotime($eta_date)) : 'Not specified'; ?></td> 
        ...
        <div class="row">
            <div class="col-6">
                ...
                <p>ETA Shipment Date: <?php echo isset($eta_date) ? date('Y-m-d H:i:s', strtotime($eta_date)) : 'Not specified'; ?></p> 
            </div>

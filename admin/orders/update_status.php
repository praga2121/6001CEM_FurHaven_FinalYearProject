<div class="container-fluid">
    <form id="status-update-form">
        ...
        <div class="form-group">
            <label for="" class="control-label">Estimated Date of Arrival (ETA)</label>
            <input type="datetime-local" name="eta_date" class="form-control" value="<?php echo isset($_GET['eta_date']) ? $_GET['eta_date'] : ''; ?>">
        </div>
    </form>
</div>

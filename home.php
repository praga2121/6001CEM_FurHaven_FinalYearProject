 ...
 <header class="bg-dark py-5" id="main-header">
    <div class="container px-4 px-lg-5 my-5">
        <div class="text-center text-white">
            <h1 class="display-4 fw-bolder">Welcome to FurHaven, We offer latest arrival Products for your Pets</h1><br>
            ...
            <?php 
                ...
                while($row = $products->fetch_assoc()):
                    ...
                    while($ir = $inventory->fetch_assoc()){
                        $inv[] = number_format($ir['price'],2);
                    }
            ?>
            <div class="col mb-5">
                <div class="card product-item">
                    <!-- Product image-->
                    <img class="card-img-top w-100 item-cover" src="<?php echo validate_image($img) ?>" alt="..." />
                    <!-- Product details-->
